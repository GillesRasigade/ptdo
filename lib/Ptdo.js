 ...
 */
var Ptdo = function( data , ptdo , bookshelf ) {
    "use strict";
    ...
    // transmission:
    if ( null === this.bookshelf && bookshelf ) {
    ...
    if ( Ptdo.prototype.models[this.ptdo] ) {
        ...
        if ( data && data.object && data.history && data.data ) {
            this.object = this.Object.forge(data.object);
            this.history = this.Object.forge(data.history);
            this.data = this.Object.forge(data.data);
        }
    }
};
...
Ptdo.prototype.init = function( config ) {
